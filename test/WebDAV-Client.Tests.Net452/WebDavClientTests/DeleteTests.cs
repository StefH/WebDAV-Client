    ...
    public class DeleteTests
    {
        ...
        public async void When_IsCalledWithDefaultArguments_Should_SendDeleteRequest()
        {
            ...
            await dispatcher.Received(1)
                .SendAsync(requestUri, HttpMethod.Delete, Arg.Is<RequestParameters>(x => !x.Headers.Any() && x.Content == null), CancellationToken.None);
        }
        ...
        public async void When_IsCalledWithCancellationToken_Should_SendRequestWithIt()
        {
            ...
            await dispatcher.Received(1)
                .SendAsync(Arg.Any<Uri>(), HttpMethod.Delete, Arg.Is<RequestParameters>(x => !x.Headers.Any() && x.Content == null), cts.Token);
        }
        ...
        public async void When_IsCalledWithLockToken_Should_SetIfHeader()
        {
            ...
            await dispatcher.Received(1)
                .SendAsync(requestUri, HttpMethod.Delete, Arg.Is(Predicates.CompareHeader("If", "(<urn:uuid:e71d4fae-5dec-22d6-fea5-00a0c91e6be4>)")), CancellationToken.None);
        }
    }
}