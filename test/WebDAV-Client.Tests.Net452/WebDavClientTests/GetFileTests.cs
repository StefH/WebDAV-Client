...
namespace WebDav.Client.Tests.WebDavClientTests
{
    public class GetFileTests
    {
        ...
        public async void When_GetRawFileIsCalled_Should_ProxyCallToGetFile()
        {
            ...
            client.GetFileAsync(Arg.Any<Uri>(), Arg.Any<bool>(), Arg.Any<CancellationToken>()).Returns(new WebDavStreamResponse(200));
            ...
            await client.Received(4).GetFileAsync(Arg.Is<Uri>(x => x.ToString() == "http://example.com/file"), false, CancellationToken.None);
        }
        ...
        public async void When_GetProcessedFileIsCalled_Should_ProxyCallToGetFile()
        {
            ...
            await client.Received(4).GetFileAsync(Arg.Is<Uri>(x => x.ToString() == "http://example.com/file"), true, CancellationToken.None);
        }
        ...
        public async void When_RequestIsSuccessfull_Should_ReturnStatusCode200()
        {
            ...
            var response1 = await client.GetFileAsync(new Uri("http://example.com/file"), false, CancellationToken.None);
            var response2 = await client.GetFileAsync(new Uri("http://example.com/file"), true, CancellationToken.None);
        ...
        public async void When_GetFile_Should_SendGetRequest()
        {
            ...
            await client.GetFileAsync(requestUri, false, CancellationToken.None);
            await client.GetFileAsync(requestUri, true, CancellationToken.None);
            await dispatcher.Received(2)
                .SendAsync(requestUri, HttpMethod.Get, Arg.Is<RequestParameters>(x => x.Content == null), CancellationToken.None);
        }
        ...
        public async void When_IsCalledWithTranslateOff_Should_SendTranslateHeaderEqualsF()
        {
            ...
            await dispatcher.Received(1)
                .SendAsync(requestUri, HttpMethod.Get, Arg.Is(Predicates.CompareHeader("Translate", "f")), CancellationToken.None);
        }
        ...
        public async void When_IsCalledWithTranslateOn_Should_SendTranslateHeaderEqualsT()
        {
            ...
            await client.GetFileAsync(requestUri, true, CancellationToken.None);
            await dispatcher.Received(1)
                .SendAsync(requestUri, HttpMethod.Get, Arg.Is(Predicates.CompareHeader("Translate", "t")), CancellationToken.None);
        }
    }
}